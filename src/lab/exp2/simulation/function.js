window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a RIGHT ANGLED TRIANGLE requires the length of the two different  sides of the RIGHT ANGLED TRAINGLE. Try again.')
		else if ( b !== 'float' )
			alert('Incorrect datatype of input variables(arguments). The value of the sides of a RIGHT ANGLED TRAINGLE need not be integers. Try again.')
		else if ( c !== 'float' )
			alert('Incorrect datatype for return type. The value of the area of a RIGHT ANGLED TRAINGLE need not be an integer. Try again.')
		else if ( d !== '(1/2)*a*b' )
			alert('Incorrect formula for calculating the area of a RIGHT ANGLED TRAINGLE. Try again.')
		else
